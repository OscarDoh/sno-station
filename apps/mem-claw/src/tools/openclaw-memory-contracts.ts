...
export type SnoStationMemMemoryRuntime = Pick<NonNullable<MemoryPluginCapability["runtime"]>, "classifyWorkspaceMemoryPaths"> & {
...
export type SnoStationMemMemoryCapability = Omit<MemoryPluginCapability, "runtime"> & {
